...
# direct methods
.method public constructor <init>(Landroid/app/Activity;Lsud;Lnxq;)V
    .locals 1
    ...
    iput-object v0, p0, Lnxr;->a:Landroid/app/Activity;
...
.method private final a(Ljava/lang/Object;)Landroid/preference/Preference;
    ...
    .line 3060
    :cond_0
    iget-boolean v0, p1, Lnfj;->b:Z

    .line 1139
    if-nez v0, :cond_2

    invoke-virtual {p1}, Lnfj;->c()Ljava/lang/CharSequence;
    ...
    invoke-direct {v0, p0, p1}, Lnxv;-><init>(Lnxr;Lnfj;)V
    ...
    .line 1149
    iget-object v0, p0, Lnxr;->c:Lnxq;

    invoke-virtual {p1}, Lnfj;->d()I

    move-result v2

    invoke-interface {v0, v2}, Lnxq;->a(I)Ljava/lang/String;
    ...
    .line 1140
    :cond_2
    invoke-virtual {p1}, Lnfj;->a()Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Lnxr;->a:Landroid/app/Activity;

    invoke-direct {v0, v1}, Landroid/preference/ListPreference;-><init>(Landroid/content/Context;)V

    .line 4158
    invoke-virtual {p0, v0, p1}, Lnxr;->a(Landroid/preference/ListPreference;Lnfo;)V
    ...
    .line 5027
    iget-object v1, p1, Lnfn;->a:Ludw;

    .line 5052
    iget-object v2, v1, Ludw;->g:Landroid/text/Spanned;

    if-nez v2, :cond_5

    .line 5053
    iget-object v2, v1, Ludw;->a:Lsxe;
    ...
    iput-object v2, v1, Ludw;->g:Landroid/text/Spanned;

    .line 5056
    :cond_5
    iget-object v1, v1, Ludw;->g:Landroid/text/Spanned;

    .line 4164
    invoke-virtual {v0, v1}, Landroid/preference/Preference;->setTitle(Ljava/lang/CharSequence;)V

    .line 4165
    invoke-virtual {p1}, Lnfn;->a()Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, p0, p1}, Lnxu;-><init>(Lnxr;Lnfn;)V
    ...
    .line 4167
    :cond_8
    invoke-virtual {p1}, Lnfn;->c()Ljava/lang/CharSequence;
    ...
    .line 6026
    iget-object v1, p1, Lnfi;->a:Ludm;

    .line 6047
    iget-object v2, v1, Ludm;->e:Landroid/text/Spanned;

    if-nez v2, :cond_a

    .line 6048
    iget-object v2, v1, Ludm;->a:Lsxe;
    ...
    iput-object v2, v1, Ludm;->e:Landroid/text/Spanned;

    .line 6051
    :cond_a
    iget-object v1, v1, Ludm;->e:Landroid/text/Spanned;

    .line 5184
    invoke-virtual {v0, v1}, Landroid/preference/Preference;->setTitle(Ljava/lang/CharSequence;)V

    .line 5185
    invoke-virtual {p1}, Lnfi;->a()Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, p0, p1}, Lnxs;-><init>(Lnxr;Lnfi;)V
...
.method private final a(Landroid/preference/PreferenceCategory;Lnfk;)V
    .locals 2

    .prologue
    .line 112
    invoke-virtual {p2}, Lnfk;->a()Ljava/lang/CharSequence;
    ...
    .line 115
    :cond_0
    invoke-virtual {p2}, Lnfk;->b()Ljava/util/List;
    ...
    .line 116
    invoke-direct {p0, v1}, Lnxr;->a(Ljava/lang/Object;)Landroid/preference/Preference;
...
.method private final a(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;Lnfm;)V
    .locals 3

    .prologue
    .line 225
    invoke-interface {p3}, Lnfm;->b()Ljava/util/List;
    ...
    .line 227
    iget-object v2, p0, Lnxr;->c:Lnxq;

    iget v0, v0, Lsjr;->a:I

    .line 228
    invoke-interface {v2, v0}, Lnxq;->a(I)Ljava/lang/String;
...
.method private final a(Landroid/preference/PreferenceScreen;Ljava/util/List;)V
    ...
    .line 6216
    invoke-virtual {v1}, Lnfk;->b()Ljava/util/List;
    ...
    .line 6213
    invoke-direct {p0, p1, v6, v2}, Lnxr;->a(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;Lnfm;)V
    ...
    invoke-direct {p0, p1, v0, v1}, Lnxr;->a(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;Lnfm;)V
...
# virtual methods
.method public final a(Landroid/preference/ListPreference;Lnfo;)V
    .locals 8
    ...
    .line 65
    invoke-virtual {p2}, Lnfo;->a()Ljava/lang/CharSequence;
    ...
    .line 69
    :cond_0
    invoke-virtual {p2}, Lnfo;->c()Ljava/lang/CharSequence;
    ...
    .line 72
    :cond_1
    invoke-virtual {p2}, Lnfo;->d()Ljava/util/List;
    ...
    .line 78
    iget-object v7, v0, Ludt;->a:Ljava/lang/String;

    aput-object v7, v5, v1

    .line 79
    iget-object v7, v0, Ludt;->b:Ljava/lang/String;

    aput-object v7, v6, v1

    .line 80
    iget-boolean v0, v0, Ludt;->c:Z
    ...
    invoke-direct {v0, p0, p2}, Lnxt;-><init>(Lnxr;Lnfo;)V
...
.method public final a(Landroid/preference/PreferenceFragment;Ljava/util/List;)V
    ...
    iget-object v4, p0, Lnxr;->a:Landroid/app/Activity;
    ...
    invoke-direct {p0, v3, v0}, Lnxr;->a(Landroid/preference/PreferenceCategory;Lnfk;)V

    goto :goto_0

    .line 1103
    :cond_0
    invoke-direct {p0, v0}, Lnxr;->a(Ljava/lang/Object;)Landroid/preference/Preference;
    ...
    .line 61
    invoke-direct {p0, v1, p2}, Lnxr;->a(Landroid/preference/PreferenceScreen;Ljava/util/List;)V
