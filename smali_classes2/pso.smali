...
# instance fields
.field private g:Lptz;


# direct methods
.method private constructor <init>(Lkxk;Ljava/security/Key;Lkxk;Lric;Llic;)V
    .locals 3

    .prologue
    .line 66
    invoke-direct {p0, p2, p3, p4}, Lrid;-><init>(Ljava/security/Key;Lkxk;Lric;)V

    .line 67
    new-instance v0, Lptz;

    invoke-direct {v0, p2, p5, p1}, Lptz;-><init>(Ljava/security/Key;Llic;Lkxk;)V

    iput-object v0, p0, Lpso;->g:Lptz;

    .line 1152
    iget-object v0, p0, Lrid;->c:Lorg/apache/http/protocol/HttpRequestHandlerRegistry;

    .line 68
    const-string v1, "/pudl"

    iget-object v2, p0, Lpso;->g:Lptz;
...
.method public static a(Lkxk;Ljava/security/Key;Lkxk;Lric;Llic;)Lpso;
    .locals 7
    ...
    invoke-direct/range {v0 .. v5}, Lpso;-><init>(Lkxk;Ljava/security/Key;Lkxk;Lric;Llic;)V
    ...
    iput-object v1, v0, Lrid;->e:Ljava/net/ServerSocket;
    ...
    .line 1146
    iget-object v2, v0, Lrid;->e:Ljava/net/ServerSocket;
    ...
    iput-object v1, v0, Lrid;->f:Ljava/util/concurrent/ExecutorService;

    .line 1148
    iget-object v1, v0, Lrid;->f:Ljava/util/concurrent/ExecutorService;

    new-instance v2, Lrie;

    invoke-direct {v2, v0}, Lrie;-><init>(Lrid;)V
...
.method public final a(Ljava/lang/String;ILjava/lang/String;JJJ)Landroid/net/Uri;
    ...
    .line 1160
    iget-object v1, p0, Lrid;->e:Ljava/net/ServerSocket;
    ...
    .line 2156
    iget-object v1, p0, Lrid;->d:Lriw;

    .line 90
    invoke-virtual {v1, v0}, Lriw;->a(Landroid/net/Uri;)Landroid/net/Uri;
