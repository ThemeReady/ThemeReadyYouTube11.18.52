...
.method static constructor <clinit>()V
    ...
    sput-wide v0, Lhmj;->t:J

    const/4 v0, 0x0

    sput-boolean v0, Lhmj;->v:Z

    return-void
.end method

.method protected constructor <init>(Landroid/content/Context;Lhmq;Lhmr;)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lhmh;-><init>(Landroid/content/Context;Lhmq;Lhmr;)V
...
.method private static a(Landroid/content/Context;Lhmq;)Ljava/lang/String;
    .locals 4

    sget-object v0, Lhmj;->r:Ljava/lang/String;
    ...
    :cond_0
    sget-object v0, Lhmj;->g:Ljava/lang/reflect/Method;
    ...
    invoke-direct {v1, v0}, Lhmk;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-interface {p1, v0}, Lhmq;->a([B)Ljava/lang/String;
...
.method private static a([BLjava/lang/String;)Ljava/lang/String;
    ...
    sget-object v1, Lhmj;->u:Lhms;

    invoke-virtual {v1, p0, p1}, Lhms;->a([BLjava/lang/String;)[B
    ...
    :try_end_0
    .catch Lhmt; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static a(Landroid/view/MotionEvent;Landroid/util/DisplayMetrics;)Ljava/util/ArrayList;
    ...
    sget-object v0, Lhmj;->h:Ljava/lang/reflect/Method;
...
.method protected static declared-synchronized a(Ljava/lang/String;Landroid/content/Context;Lhmq;)V
    .locals 21
    ...
    invoke-direct {v2, v0}, Lhms;-><init>(Lhmq;)V

    sput-object v2, Lhmj;->u:Lhms;

    sput-object p0, Lhmj;->q:Ljava/lang/String;
    :try_end_1
    .catch Lhmk; {:try_start_1 .. :try_end_1} :catch_1
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_1 .. :try_end_1} :catch_2
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    .line 1000
    :try_start_2
    sget-object v2, Lhmj;->u:Lhms;

    .line 2000
    const-string v3, "hgCk8A4GQuleIlan21Er1535C3f4u3krghh5apIgsmw="

    .line 1000
    invoke-virtual {v2, v3}, Lhms;->a(Ljava/lang/String;)[B
    ...
    .line 1000
    invoke-virtual {v2, v5, v3}, Lhms;->a([BLjava/lang/String;)[B
    ...
    .catch Lhmt; {:try_start_2 .. :try_end_2} :catch_5
    .catch Ljava/lang/NoSuchMethodException; {:try_start_2 .. :try_end_2} :catch_6
    .catch Ljava/lang/NullPointerException; {:try_start_2 .. :try_end_2} :catch_7
    .catch Lhmk; {:try_start_2 .. :try_end_2} :catch_1
    ...
    invoke-direct {v3, v2}, Lhmk;-><init>(Ljava/lang/Throwable;)V

    throw v3
    :try_end_3
    .catch Lhmk; {:try_start_3 .. :try_end_3} :catch_1
    ...
    .line 1000
    invoke-static {v5, v6}, Lhmj;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v8}, Lhmj;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v9}, Lhmj;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v10}, Lhmj;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v11}, Lhmj;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v12}, Lhmj;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v13}, Lhmj;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v14}, Lhmj;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 1000
    invoke-static {v5, v15}, Lhmj;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5, v0}, Lhmj;->a([BLjava/lang/String;)Ljava/lang/String;
    ...
    sput-object v6, Lhmj;->d:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmj;->e:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmj;->f:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmj;->g:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmj;->h:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmj;->i:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmj;->j:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmj;->k:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmj;->l:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmj;->m:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmj;->n:Ljava/lang/reflect/Method;
    ...
    sput-object v6, Lhmj;->o:Ljava/lang/reflect/Method;
    ...
    sput-object v2, Lhmj;->p:Ljava/lang/reflect/Method;
    :try_end_5
    ...
    .catch Lhmt; {:try_start_6 .. :try_end_6} :catch_5
    ...
    sput-wide v2, Lhmj;->t:J

    const/4 v2, 0x1

    sput-boolean v2, Lhmj;->v:Z
    :try_end_7
    .catch Lhmk; {:try_start_7 .. :try_end_7} :catch_1
    ...
    .catch Lhmt; {:try_start_8 .. :try_end_8} :catch_5
    ...
    .catch Lhmk; {:try_start_8 .. :try_end_8} :catch_1
    ...
    throw v3
    :try_end_9
    .catch Lhmk; {:try_start_9 .. :try_end_9} :catch_1
    ...
    throw v3
    :try_end_a
    .catch Lhmk; {:try_start_a .. :try_end_a} :catch_1
...
.method private static b()Ljava/lang/Long;
    ...
    sget-object v0, Lhmj;->d:Ljava/lang/reflect/Method;
...
.method private static b(Landroid/content/Context;Lhmq;)Ljava/lang/String;
    .locals 4

    sget-object v0, Lhmj;->s:Ljava/lang/String;
    ...
    :cond_0
    sget-object v0, Lhmj;->j:Ljava/lang/reflect/Method;
    ...
    sput-object v0, Lhmj;->s:Ljava/lang/String;
    :try_end_1
    .catch Ljava/lang/IllegalAccessException; {:try_start_1 .. :try_end_1} :catch_0
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_1 .. :try_end_1} :catch_1
...
.method private static c()Ljava/lang/String;
    ...
    sget-object v0, Lhmj;->f:Ljava/lang/reflect/Method;
...
.method private static d()Ljava/lang/Long;
    ...
    sget-object v0, Lhmj;->e:Ljava/lang/reflect/Method;
...
.method static d(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v0, Lhmj;->i:Ljava/lang/reflect/Method;
...
.method private static e(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v0, Lhmj;->m:Ljava/lang/reflect/Method;
...
.method private static f(Landroid/content/Context;)Ljava/lang/Long;
    ...
    sget-object v0, Lhmj;->n:Ljava/lang/reflect/Method;
...
.method private static g(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    sget-object v0, Lhmj;->k:Ljava/lang/reflect/Method;
...
.method private static h(Landroid/content/Context;)[I
    ...
    sget-object v0, Lhmj;->l:Ljava/lang/reflect/Method;
...
.method private static i(Landroid/content/Context;)I
    ...
    sget-object v0, Lhmj;->o:Ljava/lang/reflect/Method;
...
.method private static j(Landroid/content/Context;)I
    ...
    sget-object v0, Lhmj;->p:Ljava/lang/reflect/Method;
...
.method protected b(Landroid/content/Context;)V
    ...
    :try_start_0
    invoke-static {}, Lhmj;->c()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lhmj;->a(ILjava/lang/String;)V
    :try_end_0
    .catch Lhmk; {:try_start_0 .. :try_end_0} :catch_c
    ...
    :try_start_1
    invoke-static {}, Lhmj;->a()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lhmj;->a(ILjava/lang/String;)V
    :try_end_1
    .catch Lhmk; {:try_start_1 .. :try_end_1} :catch_b
    ...
    invoke-virtual {p0, v2, v0, v1}, Lhmj;->a(IJ)V

    sget-wide v2, Lhmj;->t:J
    ...
    invoke-virtual {p0, v0, v2, v3}, Lhmj;->a(IJ)V
    :try_end_2
    .catch Lhmk; {:try_start_2 .. :try_end_2} :catch_a
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_0

    :cond_0
    :goto_2
    :try_start_3
    invoke-static {p1}, Lhmj;->g(Landroid/content/Context;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v2, v4, v5}, Lhmj;->a(IJ)V
    ...
    invoke-virtual {p0, v2, v0, v1}, Lhmj;->a(IJ)V
    :try_end_3
    .catch Lhmk; {:try_start_3 .. :try_end_3} :catch_9
    ...
    :try_start_4
    invoke-static {}, Lhmj;->d()Ljava/lang/Long;
    ...
    invoke-virtual {p0, v0, v2, v3}, Lhmj;->a(IJ)V
    :try_end_4
    .catch Lhmk; {:try_start_4 .. :try_end_4} :catch_8
    ...
    :try_start_5
    iget-object v1, p0, Lhmj;->c:Lhmq;

    invoke-static {p1, v1}, Lhmj;->a(Landroid/content/Context;Lhmq;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lhmj;->a(ILjava/lang/String;)V
    :try_end_5
    .catch Lhmk; {:try_start_5 .. :try_end_5} :catch_7
    ...
    invoke-static {p1, v1}, Lhmj;->b(Landroid/content/Context;Lhmq;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lhmj;->a(ILjava/lang/String;)V
    :try_end_6
    .catch Lhmk; {:try_start_6 .. :try_end_6} :catch_6
    .catch Ljava/io/IOException; {:try_start_6 .. :try_end_6} :catch_0

    :goto_6
    :try_start_7
    invoke-static {p1}, Lhmj;->h(Landroid/content/Context;)[I
    ...
    invoke-virtual {p0, v1, v2, v3}, Lhmj;->a(IJ)V
    ...
    invoke-virtual {p0, v1, v2, v3}, Lhmj;->a(IJ)V
    :try_end_7
    .catch Lhmk; {:try_start_7 .. :try_end_7} :catch_5
    .catch Ljava/io/IOException; {:try_start_7 .. :try_end_7} :catch_0

    :goto_7
    :try_start_8
    invoke-static {p1}, Lhmj;->i(Landroid/content/Context;)I
    ...
    invoke-virtual {p0, v1, v2, v3}, Lhmj;->a(IJ)V
    :try_end_8
    .catch Lhmk; {:try_start_8 .. :try_end_8} :catch_4
    .catch Ljava/io/IOException; {:try_start_8 .. :try_end_8} :catch_0

    :goto_8
    :try_start_9
    invoke-static {p1}, Lhmj;->j(Landroid/content/Context;)I
    ...
    invoke-virtual {p0, v1, v2, v3}, Lhmj;->a(IJ)V
    :try_end_9
    .catch Lhmk; {:try_start_9 .. :try_end_9} :catch_3
    ...
    :try_start_a
    invoke-static {p1}, Lhmj;->e(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, v0, v1}, Lhmj;->a(ILjava/lang/String;)V
    :try_end_a
    .catch Lhmk; {:try_start_a .. :try_end_a} :catch_2
    ...
    :try_start_b
    invoke-static {p1}, Lhmj;->f(Landroid/content/Context;)Ljava/lang/Long;
    ...
    invoke-virtual {p0, v0, v2, v3}, Lhmj;->a(IJ)V
    :try_end_b
    .catch Lhmk; {:try_start_b .. :try_end_b} :catch_1
...
.method protected final c(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, v0, v1}, Lhmj;->a(ILjava/lang/String;)V
    :try_end_0
    .catch Lhmk; {:try_start_0 .. :try_end_0} :catch_6
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p0, v0, v1}, Lhmj;->a(ILjava/lang/String;)V
    :try_end_1
    .catch Lhmk; {:try_start_1 .. :try_end_1} :catch_5
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-virtual {p0, v0, v2, v3}, Lhmj;->a(IJ)V
    :try_end_2
    .catch Lhmk; {:try_start_2 .. :try_end_2} :catch_4
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_0

    :goto_2
    :try_start_3
    iget-object v0, p0, Lhmj;->a:Landroid/view/MotionEvent;

    iget-object v1, p0, Lhmj;->b:Landroid/util/DisplayMetrics;

    invoke-static {v0, v1}, Lhmj;->a(Landroid/view/MotionEvent;Landroid/util/DisplayMetrics;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v2, v0, v1}, Lhmj;->a(IJ)V
    :try_end_3
    .catch Lhmk; {:try_start_3 .. :try_end_3} :catch_3
    .catch Ljava/io/IOException; {:try_start_3 .. :try_end_3} :catch_0
    ...
    invoke-virtual {p0, v0, v1}, Lhmj;->a(ILjava/lang/String;)V
    :try_end_4
    .catch Lhmk; {:try_start_4 .. :try_end_4} :catch_2
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_4} :catch_0
    ...
    invoke-virtual {p0, v0, v2, v3}, Lhmj;->a(IJ)V
    :try_end_5
    .catch Lhmk; {:try_start_5 .. :try_end_5} :catch_1
    .catch Ljava/io/IOException; {:try_start_5 .. :try_end_5} :catch_0
