...
.method public final handleMessage(Landroid/os/Message;)Z
    ...
    invoke-direct {v4, v0}, Lbn;-><init>(Landroid/support/design/widget/Snackbar;)V
    ...
    invoke-direct {v3, v0}, Lbg;-><init>(Landroid/support/design/widget/Snackbar;)V

    .line 4117
    iput-object v3, v4, Landroid/support/design/widget/SwipeDismissBehavior;->b:Lby;

    .line 1472
    check-cast v1, Lab;

    invoke-virtual {v1, v4}, Lab;->a(Ly;)V
    ...
    invoke-direct {v1, v0}, Lbh;-><init>(Landroid/support/design/widget/Snackbar;)V

    .line 4794
    iput-object v1, v6, Landroid/support/design/widget/Snackbar$SnackbarLayout;->d:Lbo;

    .line 1499
    invoke-static {v6}, Lrw;->v(Landroid/view/View;)Z
    ...
    .line 6133
    iget-object v1, v0, Lbq;->a:Ljava/lang/Object;
    ...
    invoke-direct {v1, v0}, Lbj;-><init>(Landroid/support/design/widget/Snackbar;)V

    .line 7790
    iput-object v1, v6, Landroid/support/design/widget/Snackbar$SnackbarLayout;->c:Lbp;
    ...
    .line 9568
    invoke-static {v6}, Lrw;->p(Landroid/view/View;)Ltp;
    ...
    invoke-virtual {v3, v4}, Ltp;->c(F)Ltp;

    move-result-object v3

    sget-object v4, Lf;->b:Landroid/view/animation/Interpolator;

    invoke-virtual {v3, v4}, Ltp;->a(Landroid/view/animation/Interpolator;)Ltp;

    move-result-object v3

    const-wide/16 v4, 0xfa

    invoke-virtual {v3, v4, v5}, Ltp;->a(J)Ltp;

    move-result-object v3

    new-instance v4, Lbm;

    invoke-direct {v4, v0, v1}, Lbm;-><init>(Landroid/support/design/widget/Snackbar;I)V

    invoke-virtual {v3, v4}, Ltp;->a(Luf;)Ltp;
