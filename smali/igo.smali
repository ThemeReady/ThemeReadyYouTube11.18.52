...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ligo;->e:Ljava/lang/String;
    ...
    sput-object v0, Ligo;->f:Ljava/lang/String;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, Ligo;->g:Ljava/util/Set;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Ligo;-><init>(Landroid/content/Context;Ligq;)V

    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Ligq;)V
    .locals 4

    sget-object v0, Ligo;->b:Ljava/lang/String;
    ...
    sget-object v3, Ligo;->c:Ljava/lang/String;

    aput-object v3, v1, v2

    invoke-direct {p0, v0, v1}, Licq;-><init>(Ljava/lang/String;[Ljava/lang/String;)V

    iput-object p2, p0, Ligo;->h:Ligq;

    iput-object p1, p0, Ligo;->i:Landroid/content/Context;
...
.method private final declared-synchronized a(Ljava/lang/String;)Z
    ...
    .line 1000
    :try_start_0
    sget-object v2, Ligo;->g:Ljava/util/Set;
    ...
    :cond_0
    :try_start_1
    iget-object v2, p0, Ligo;->i:Landroid/content/Context;

    sget-object v3, Ligo;->f:Ljava/lang/String;
    ...
    sget-object v1, Ligo;->g:Ljava/util/Set;
...
.method public final b(Ljava/util/Map;)V
    ...
    sget-object v0, Ligo;->e:Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, Ligo;->a(Ljava/lang/String;)Z
    ...
    :cond_2
    sget-object v0, Ligo;->c:Ljava/lang/String;
    ...
    iget-object v2, p0, Ligo;->h:Ligq;

    invoke-interface {v2}, Ligq;->a()Libw;

    move-result-object v2

    invoke-interface {v2, v0}, Libw;->a(Ljava/lang/String;)Z
    ...
    :try_start_0
    sget-object v0, Ligo;->g:Ljava/util/Set;

    invoke-interface {v0, v1}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    iget-object v0, p0, Ligo;->i:Landroid/content/Context;

    sget-object v3, Ligo;->f:Ljava/lang/String;

    const-string v4, "true"

    invoke-static {v0, v3, v1, v4}, Lifv;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
