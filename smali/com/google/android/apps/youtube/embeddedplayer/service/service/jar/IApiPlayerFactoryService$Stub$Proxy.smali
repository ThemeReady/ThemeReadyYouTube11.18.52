...
# virtual methods
.method public final a(Lfmm;Lfmv;Lfnb;Lfne;Lfmj;Lfmg;Lfnh;Lfmp;Lfms;Lfmy;Lfnk;Z)Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IApiPlayerService;
    .locals 5
    ...
    invoke-interface {p1}, Lfmm;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p2}, Lfmv;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p3}, Lfnb;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p4}, Lfne;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p5}, Lfmj;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p6}, Lfmg;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p7}, Lfnh;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p8}, Lfmp;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p9}, Lfms;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p10}, Lfmy;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface/range {p11 .. p11}, Lfnk;->asBinder()Landroid/os/IBinder;
