...
.method public setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 1084
    :cond_1
    iget-object v0, p0, Lcom/google/android/apps/youtube/app/ui/TintableImageView;->c:Ldqe;
    ...
    invoke-direct {v0, v1}, Ldqe;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/android/apps/youtube/app/ui/TintableImageView;->c:Ldqe;
    ...
    .line 2245
    iget-object v1, v0, Ldqe;->b:Landroid/content/res/ColorStateList;

    if-nez v1, :cond_3

    .line 2246
    iget-object v1, v0, Ldqe;->a:Landroid/content/Context;

    sget v2, Lvny;->d:I

    invoke-static {v1, v2, v4}, Llkj;->a(Landroid/content/Context;II)I
    ...
    invoke-static {v3, v4, v2}, Llkj;->a(Landroid/content/Context;II)I

    move-result v3

    .line 2250
    invoke-virtual {v0, v1, v2, v3}, Ldqe;->a(III)Landroid/content/res/ColorStateList;

    move-result-object v1

    iput-object v1, v0, Ldqe;->b:Landroid/content/res/ColorStateList;

    .line 2253
    :cond_3
    iget-object v0, v0, Ldqe;->b:Landroid/content/res/ColorStateList;

    .line 1374
    sget-object v1, Landroid/graphics/PorterDuff$Mode;->SRC_IN:Landroid/graphics/PorterDuff$Mode;

    invoke-static {p1, v0, v1}, Ldqe;->b(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, p1, v1}, Ldqe;->a(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)Landroid/graphics/drawable/Drawable;
