...
.method protected final onAttachedToWindow()V
    ...
    .line 38
    iget-object v0, p0, Lozw;->b:Landroid/view/View;
    ...
    invoke-virtual {p0, v0}, Lozw;->removeView(Landroid/view/View;)V

    .line 40
    const/4 v0, 0x0

    iput-object v0, p0, Lozw;->b:Landroid/view/View;

    .line 43
    :cond_0
    invoke-virtual {p0}, Lozw;->isHardwareAccelerated()Z
    ...
    invoke-virtual {p0}, Lozw;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1}, Lpac;-><init>(Landroid/content/Context;)V

    .line 45
    iput-object v0, p0, Lozw;->a:Lozr;
    ...
    invoke-virtual {p0, v0}, Lozw;->addView(Landroid/view/View;)V

    .line 54
    iget-boolean v0, p0, Lozw;->c:Z

    if-eqz v0, :cond_1

    .line 55
    iput-boolean v2, p0, Lozw;->c:Z

    .line 56
    iget-object v0, p0, Lozw;->a:Lozr;

    iget-object v1, p0, Lozw;->e:Lozs;

    invoke-interface {v0, v1}, Lozr;->a(Lozs;)V

    .line 57
    iget-boolean v0, p0, Lozw;->d:Z

    if-eqz v0, :cond_1

    .line 58
    invoke-virtual {p0, v2}, Lozw;->a(I)V
...
.method protected final onLayout(ZIIII)V
    ...
    .line 76
    invoke-virtual {p0}, Lozw;->getChildCount()I
    ...
    .line 77
    invoke-virtual {p0, v3}, Lozw;->getChildAt(I)Landroid/view/View;
...
.method protected final onMeasure(II)V
    ...
    .line 66
    invoke-virtual {p0, v1}, Lozw;->getChildAt(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v1, v0}, Lozw;->setMeasuredDimension(II)V
    ...
    .line 70
    :cond_0
    invoke-virtual {p0, v1, v1}, Lozw;->setMeasuredDimension(II)V
