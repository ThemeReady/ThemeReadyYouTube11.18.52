...
# direct methods
.method constructor <init>(Lorg/apache/http/client/HttpClient;Landroid/content/Context;Lifz;)V
    .locals 9
    ...
    iput-object v1, p0, Lify;->c:Landroid/content/Context;
    ...
    iput-object p1, p0, Lify;->b:Lorg/apache/http/client/HttpClient;

    iput-object p3, p0, Lify;->d:Lifz;
...
.method private static a(Lidi;)Ljava/net/URL;
    .locals 2
...
.method public final a(Ljava/util/List;)V
    ...
    invoke-static {v0}, Lify;->a(Lidi;)Ljava/net/URL;
    ...
    iget-object v2, p0, Lify;->d:Lifz;

    invoke-interface {v2, v0}, Lifz;->b(Lidi;)V
    ...
    :cond_0
    invoke-direct {p0, v2}, Lify;->a(Ljava/net/URL;)Lorg/apache/http/HttpEntityEnclosingRequest;
    ...
    invoke-static {v6}, Lify;->a(Lorg/apache/http/HttpEntityEnclosingRequest;)V

    if-eqz v1, :cond_2

    :try_start_0
    iget-object v2, p0, Lify;->c:Landroid/content/Context;

    invoke-static {v2}, Liea;->a(Landroid/content/Context;)V

    move v1, v3

    :cond_2
    iget-object v2, p0, Lify;->b:Lorg/apache/http/client/HttpClient;
    ...
    invoke-interface {v2, v0}, Lifz;->c(Lidi;)V
    ...
    invoke-interface {v2, v0}, Lifz;->a(Lidi;)V
    :try_end_0
    ...
    invoke-static {v6}, Libz;->b(Ljava/lang/String;)V
...
.method public final a()Z
    ...
    iget-object v0, p0, Lify;->c:Landroid/content/Context;
