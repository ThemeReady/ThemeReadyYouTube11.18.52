...
.method public constructor <init>(Landroid/content/Context;Landroid/widget/EditText;Landroid/widget/Spinner;)V
    ...
    iput-object v0, p0, Ljpk;->c:Landroid/widget/EditText;
    ...
    iput-object v0, p0, Ljpk;->d:Landroid/widget/Spinner;
    ...
    invoke-direct {v0, p3}, Ljpm;-><init>(Landroid/widget/Spinner;)V
    ...
    invoke-direct {v0, p0, p2}, Ljpn;-><init>(Ljpk;Landroid/widget/EditText;)V
    ...
    invoke-direct {v0, p1}, Ljpo;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Ljpk;->b:Ljpo;

    .line 84
    iget-object v0, p0, Ljpk;->b:Ljpo;
...
# virtual methods
.method final a(Lmzw;Landroid/os/Bundle;)V
    .locals 4
    ...
    .line 95
    iget-object v0, p0, Ljpk;->c:Landroid/widget/EditText;
    ...
    iget-object v3, v3, Lsss;->b:Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, Ljpo;->addAll(Ljava/util/Collection;)V
    ...
    iget-boolean v0, v0, Lssr;->c:Z

    if-eqz v0, :cond_2

    .line 2114
    iget-object v0, p0, Ljpk;->d:Landroid/widget/Spinner;
