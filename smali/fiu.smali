...
# direct methods
.method public constructor <init>(Landroid/view/View;Lfig;Lfjb;)V
    .locals 6
    ...
    .line 136
    invoke-direct/range {v0 .. v5}, Lfiu;-><init>(Landroid/view/View;Lfig;Lfjb;Landroid/os/Looper;Ljava/util/Random;)V

    .line 149
    return-void
.end method

.method private constructor <init>(Landroid/view/View;Lfig;Lfjb;Landroid/os/Looper;Ljava/util/Random;)V
    .locals 2
    ...
    iput-object v0, p0, Lfiu;->a:Landroid/view/View;
    ...
    iput-object v0, p0, Lfiu;->c:Ljava/util/Random;

    .line 116
    iput-boolean v1, p0, Lfiu;->p:Z

    .line 117
    iput-boolean v1, p0, Lfiu;->q:Z
    ...
    invoke-static {v1, v0}, Lkxi;->a(ZLjava/lang/Object;)V
    ...
    iput-object v0, p0, Lfiu;->s:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lfiu;->t:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lfiu;->u:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lfiu;->v:Landroid/graphics/Rect;
...
.method private final a(Landroid/view/View;)Z
    ...
    .line 283
    iget-object v0, p0, Lfiu;->a:Landroid/view/View;

    iget-object v1, p0, Lfiu;->s:Landroid/graphics/Rect;

    invoke-static {v0, v1}, Lfiu;->a(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 285
    iget-object v2, p0, Lfiu;->a:Landroid/view/View;
    ...
    invoke-static {v0, v2, v1}, Lfiu;->a(Landroid/view/View;Landroid/view/ViewGroup;Landroid/graphics/Rect;)V

    .line 292
    iget-boolean v1, p0, Lfiu;->p:Z

    if-eqz v1, :cond_1

    .line 294
    iget-object v1, p0, Lfiu;->t:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, Lfiu;->s:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Lfiu;->t:Landroid/graphics/Rect;

    iget-object v3, p0, Lfiu;->s:Landroid/graphics/Rect;

    .line 301
    invoke-static {v2, v3}, Lfiu;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Ljava/lang/String;
    ...
    iput-object v0, p0, Lfiu;->l:Ljava/lang/String;
    ...
    .line 313
    iget-object v0, p0, Lfiu;->s:Landroid/graphics/Rect;
    ...
    invoke-direct/range {v0 .. v6}, Lfiu;->a(Landroid/view/View;Landroid/view/ViewGroup;IIII)Z
...
.method private final a(Landroid/view/View;Landroid/view/ViewGroup;IIII)Z
    ...
    .prologue
    .line 332
    iget-object v4, p0, Lfiu;->u:Landroid/graphics/Rect;
    ...
    invoke-static {v0, v1, v4}, Lfiu;->a(Landroid/view/View;Landroid/view/ViewGroup;Landroid/graphics/Rect;)V

    .line 335
    iget-object v4, p0, Lfiu;->v:Landroid/graphics/Rect;

    move-object/from16 v0, p1

    invoke-static {v0, v4}, Lfiu;->a(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 336
    iget-object v4, p0, Lfiu;->v:Landroid/graphics/Rect;

    iget-object v5, p0, Lfiu;->u:Landroid/graphics/Rect;

    iget v5, v5, Landroid/graphics/Rect;->left:I

    iget-object v6, p0, Lfiu;->u:Landroid/graphics/Rect;
    ...
    iget-object v8, p0, Lfiu;->u:Landroid/graphics/Rect;

    iget-object v9, p0, Lfiu;->v:Landroid/graphics/Rect;
    ...
    .line 3367
    invoke-static {v9, v8}, Lfiu;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Ljava/lang/String;
    ...
    iput-object v4, p0, Lfiu;->l:Ljava/lang/String;
    ...
    .line 3371
    invoke-static {v8, v9}, Lfiu;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Ljava/lang/String;
    ...
    .line 355
    invoke-direct/range {v4 .. v10}, Lfiu;->a(Landroid/view/View;Landroid/view/ViewGroup;IIII)Z
...
.method public final a()V
    ...
    .line 153
    iget-object v0, p0, Lfiu;->h:Landroid/os/Handler;
...
.method public final c()Z
    ...
    .line 261
    invoke-direct {p0, v0}, Lfiu;->a(Landroid/view/View;)Z
