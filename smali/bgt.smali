...
# instance fields
.field private final g:Lbbc;

.field private final h:Landroid/util/DisplayMetrics;

.field private final i:Lbax;
...
.method public constructor <init>(Landroid/util/DisplayMetrics;Lbbc;Lbax;)V
    .locals 1
...
.method private final a(Ljava/io/InputStream;)I
    ...
    iget-object v2, p0, Lbgt;->i:Lbax;

    invoke-direct {v1, p1, v2}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;-><init>(Ljava/io/InputStream;Lbax;)V
...
.method private final a(Ljava/io/InputStream;Laxl;)Landroid/graphics/Bitmap$Config;
    .locals 4
...
.method private final b(Ljava/io/InputStream;)Z
    ...
    iget-object v1, p0, Lbgt;->i:Lbax;

    invoke-direct {v0, p1, v1}, Lcom/bumptech/glide/load/resource/bitmap/ImageHeaderParser;-><init>(Ljava/io/InputStream;Lbax;)V
...
# virtual methods
.method public final a(Ljava/io/InputStream;IILaxt;Lbgv;)Lbaq;
    .locals 18
    ...
    iget-object v2, v0, Lbgt;->i:Lbax;

    const/high16 v3, 0x10000

    const-class v4, [B

    invoke-interface {v2, v3, v4}, Lbax;->a(ILjava/lang/Class;)Ljava/lang/Object;
    ...
    .line 154
    sget-object v3, Lbgt;->a:Laxq;

    move-object/from16 v0, p4

    invoke-virtual {v0, v3}, Laxt;->a(Laxq;)Ljava/lang/Object;
    ...
    .line 155
    sget-object v4, Lbgt;->b:Laxq;

    move-object/from16 v0, p4

    invoke-virtual {v0, v4}, Laxt;->a(Laxq;)Ljava/lang/Object;
    ...
    invoke-direct {v0, v1, v3}, Lbgt;->a(Ljava/io/InputStream;Laxl;)Landroid/graphics/Bitmap$Config;
    ...
    .line 5496
    invoke-interface {v4, v6, v8, v3}, Lbbc;->b(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    iget-object v3, v0, Lbgt;->g:Lbbc;

    move-object/from16 v0, p5

    invoke-interface {v0, v3, v4}, Lbgv;->a(Lbbc;Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v3, v4, v12}, Lbhg;->a(Lbbc;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    iget-object v5, v0, Lbgt;->g:Lbbc;

    invoke-interface {v5, v4}, Lbbc;->a(Landroid/graphics/Bitmap;)V
    ...
    invoke-static {v3, v4}, Lbgf;->a(Landroid/graphics/Bitmap;Lbbc;)Lbgf;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v4, v0, Lbgt;->i:Lbax;

    const-class v5, [B

    invoke-interface {v4, v2, v5}, Lbax;->a(Ljava/lang/Object;Ljava/lang/Class;)V
