...
# direct methods
.method static a(Landroid/app/Notification;Lhe;)V
    .locals 14
    ...
    instance-of v0, v0, Labw;

    if-eqz v0, :cond_2

    .line 60
    iget-object v0, p1, Lhe;->a:Landroid/content/Context;

    iget-object v1, p1, Lhe;->b:Ljava/lang/CharSequence;

    iget-object v2, p1, Lhe;->c:Ljava/lang/CharSequence;

    iget-object v3, p1, Lhe;->f:Ljava/lang/CharSequence;

    iget-object v5, p1, Lhe;->e:Landroid/graphics/Bitmap;

    iget-object v6, p1, Lhe;->j:Ljava/lang/CharSequence;

    iget-object v7, p1, Lhe;->t:Landroid/app/Notification;

    iget-wide v8, v7, Landroid/app/Notification;->when:J

    iget-object v12, p1, Lhe;->p:Ljava/util/ArrayList;
    ...
    .line 2119
    invoke-static/range {v0 .. v11}, Labx;->a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIZ)Landroid/widget/RemoteViews;
    ...
    invoke-static {v0, v1}, Labx;->a(Landroid/content/Context;Lhw;)Landroid/widget/RemoteViews;
...
.method static a(Lgx;Lhe;)V
    ...
    iget-object v8, p1, Lhe;->t:Landroid/app/Notification;

    iget-wide v8, v8, Landroid/app/Notification;->when:J

    iget-object v12, p1, Lhe;->p:Ljava/util/ArrayList;

    iget-object v13, v7, Labw;->a:[I
    ...
    .line 2054
    invoke-interface {p0}, Lgx;->a()Landroid/app/Notification$Builder;
...
.method static b(Lgx;Lhq;)V
    ...
    .line 37
    iget-object v1, p1, Labw;->a:[I

    iget-object v0, p1, Labw;->d:Lmm;
    ...
    .line 1813
    iget-object v0, v0, Lmm;->a:Ljava/lang/Object;
