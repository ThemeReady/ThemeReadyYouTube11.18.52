...
.field private d:Lihh;

.field private e:Lgvj;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0, v1, v2}, Lihd;-><init>(Landroid/content/Context;Lgvj;Ljava/lang/String;Ljava/util/concurrent/Executor;)V

    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Lgvj;Ljava/lang/String;Ljava/util/concurrent/Executor;)V
    .locals 2

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lihd;->c:Landroid/content/Context;

    iput-object p2, p0, Lihd;->e:Lgvj;

    const/16 v0, 0x7d0

    iput v0, p0, Lihd;->f:I

    iput-object p4, p0, Lihd;->b:Ljava/util/concurrent/Executor;

    new-instance v0, Lihh;

    iget-object v1, p0, Lihd;->c:Landroid/content/Context;

    invoke-direct {v0, p0, v1, p3}, Lihh;-><init>(Lihd;Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lihd;->d:Lihh;
...
.method private final a()Ljava/util/List;
    ...
    .line 0
    :try_start_0
    iget-object v0, p0, Lihd;->e:Lgvj;

    invoke-interface {v0}, Lgvj;->a()J

    move-result-wide v0

    invoke-direct {p0, v0, v1}, Lihd;->a(J)V

    invoke-direct {p0}, Lihd;->b()Ljava/util/List;
    ...
    iget-object v4, v0, Lihi;->a:Ljava/lang/String;

    iget-object v0, v0, Lihi;->b:[B

    invoke-static {v0}, Lihd;->a([B)Ljava/lang/Object;

    move-result-object v0

    invoke-direct {v3, v4, v0}, Libo;-><init>(Ljava/lang/String;Ljava/lang/Object;)V
...
.method private final a(I)Ljava/util/List;
    ...
    invoke-direct {p0, v0}, Lihd;->b(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method static synthetic a(Lihd;)Ljava/util/List;
    .locals 1

    invoke-direct {p0}, Lihd;->a()Ljava/util/List;
...
.method static synthetic a(Lihd;Ljava/lang/String;)V
    .locals 7
...
.method static synthetic a(Lihd;Ljava/util/List;J)V
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Lihd;->b(Ljava/util/List;J)V
...
.method static synthetic b(Lihd;)Landroid/content/Context;
    .locals 1

    iget-object v0, p0, Lihd;->c:Landroid/content/Context;
...
.method private final b(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_0
    iget-object v0, p0, Lihd;->d:Lihh;

    invoke-virtual {v0}, Lihh;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private final b()Ljava/util/List;
    ...
    invoke-direct {v0, v2, v3}, Lihi;-><init>(Ljava/lang/String;[B)V
...
.method private final declared-synchronized b(Ljava/util/List;J)V
    ...
    invoke-direct {p0, v2, v3}, Lihd;->a(J)V
    ...
    invoke-direct {p0, v0}, Lihd;->a(I)Ljava/util/List;
    ...
    invoke-direct {p0, p1, v0, v1}, Lihd;->c(Ljava/util/List;J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {p0, v1}, Lihd;->b(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method private final c()I
    ...
    invoke-direct {p0, v2}, Lihd;->b(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
...
.method private final c(Ljava/util/List;J)V
    ...
    iget-object v5, v0, Lihi;->a:Ljava/lang/String;
...
.method private final d()V
    ...
    invoke-virtual {v0}, Lihh;->close()V
    :try_end_0
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final a(Libr;)V
    ...
    iget-object v0, p0, Lihd;->b:Ljava/util/concurrent/Executor;

    new-instance v1, Lihf;

    invoke-direct {v1, p0, p1}, Lihf;-><init>(Lihd;Libr;)V
...
.method public final a(Ljava/lang/String;)V
    ...
    invoke-direct {v1, p0, p1}, Lihg;-><init>(Lihd;Ljava/lang/String;)V
...
.method public final a(Ljava/util/List;J)V
    ...
    iget-object v4, v0, Libo;->a:Ljava/lang/String;

    iget-object v0, v0, Libo;->b:Ljava/lang/Object;

    invoke-static {v0}, Lihd;->a(Ljava/lang/Object;)[B

    move-result-object v0

    invoke-direct {v3, v4, v0}, Lihi;-><init>(Ljava/lang/String;[B)V
    ...
    invoke-direct {v2, p0, v1, p2, p3}, Lihe;-><init>(Lihd;Ljava/util/List;J)V
