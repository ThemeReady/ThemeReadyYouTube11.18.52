...
.field public static final HIDDEN_METHOD_INVOKER:Laps;
...
.field private final mDrawableManager:Lakj;
...
.field private mOnCloseListener:Lapt;
...
.field private mOnQueryChangeListener:Lapu;

.field private mOnQueryTextFocusChangeListener:Landroid/view/View$OnFocusChangeListener;

.field private mOnSearchClickListener:Landroid/view/View$OnClickListener;

.field private mOnSuggestionListener:Lapv;
...
.field private mSuggestionsAdapter:Lwo;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Laps;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, p0}, Lapg;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lapq;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lapr;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Laph;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lapi;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-direct {v0, p0}, Lapj;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->mDrawableManager:Lakj;

    .line 282
    sget-object v0, Lada;->bg:[I
    ...
    invoke-virtual {v1, v2, v3}, Laqi;->e(II)I
    ...
    invoke-virtual {v1, v2}, Laqi;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v0}, Laqi;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v0, v2}, Laqi;->e(II)I
    ...
    invoke-direct {v2, p0}, Lapm;-><init>(Landroid/support/v7/widget/SearchView;)V
    ...
    invoke-virtual {v1, v0, v5}, Laqi;->a(IZ)Z
    ...
    invoke-virtual {v1, v0, v4}, Laqi;->c(II)I
    ...
    invoke-virtual {v1, v0}, Laqi;->c(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v0, v4}, Laqi;->a(II)I
    ...
    .line 3181
    iget-object v0, v1, Laqi;->a:Landroid/content/res/TypedArray;
...
.method public static synthetic access$100(Landroid/support/v7/widget/SearchView;)Lwo;
    .locals 1

    .prologue
    .line 103
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lwo;
...
.method private addOnLayoutChangeListenerToDropDownAnchorBase()V
    ...
    invoke-direct {v1, p0}, Lapo;-><init>(Landroid/support/v7/widget/SearchView;)V
...
.method private addOnLayoutChangeListenerToDropDownAnchorSDK11()V
    ...
    invoke-direct {v1, p0}, Lapn;-><init>(Landroid/support/v7/widget/SearchView;)V
...
.method private createIntentFromSuggestion(Landroid/database/Cursor;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p1, v0}, Laqa;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v2}, Laqa;->a(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
...
.method private forceSuggestionQuery()V
    ...
    .prologue
    .line 1662
    sget-object v0, Landroid/support/v7/widget/SearchView;->HIDDEN_METHOD_INVOKER:Laps;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mSearchSrcTextView:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    .line 6843
    iget-object v2, v0, Laps;->a:Ljava/lang/reflect/Method;

    if-eqz v2, :cond_0

    .line 6845
    :try_start_0
    iget-object v0, v0, Laps;->a:Ljava/lang/reflect/Method;
    ...
    .line 6852
    iget-object v2, v0, Laps;->b:Ljava/lang/reflect/Method;

    if-eqz v2, :cond_1

    .line 6854
    :try_start_1
    iget-object v0, v0, Laps;->b:Ljava/lang/reflect/Method;
...
.method private launchSuggestion(IILjava/lang/String;)Z
    ...
    .line 6194
    iget-object v0, v0, Lwo;->c:Landroid/database/Cursor;
...
.method private onCloseClicked()V
    ...
    .line 1178
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Lapt;
...
.method private onItemClicked(IILjava/lang/String;)Z
    ...
    .line 1351
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lapv;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lapv;

    invoke-interface {v1}, Lapv;->b()Z
...
.method private onItemSelected(I)Z
    ...
    .prologue
    .line 1362
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lapv;
...
.method private onSubmitQuery()V
    ...
    .line 1158
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lapu;
...
.method private onSuggestionsKey(Landroid/view/View;ILandroid/view/KeyEvent;)Z
    ...
    invoke-static {p3}, Lqf;->a(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, v1}, Laps;->a(Landroid/widget/AutoCompleteTextView;)V
...
.method private onTextChanged(Ljava/lang/CharSequence;)V
    ...
    .line 1149
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lapu;
...
.method private rewriteQueryFromSuggestion(I)V
    ...
    .line 1405
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lwo;

    .line 5194
    iget-object v1, v1, Lwo;->c:Landroid/database/Cursor;
    ...
    .line 1411
    iget-object v2, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lwo;

    invoke-virtual {v2, v1}, Lwo;->b(Landroid/database/Cursor;)Ljava/lang/CharSequence;
...
.method private updateSearchAutoComplete()V
    ...
    invoke-virtual {v0, v2}, Lwo;->a(Landroid/database/Cursor;)V
    ...
    invoke-direct {v0, v2, p0, v3, v4}, Laqa;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lwo;
...
.method public clearFocus()V
    ...
    .line 513
    invoke-super {p0}, Lamq;->clearFocus()V
...
.method public getSuggestionsAdapter()Lwo;
    .locals 1
...
.method protected onMeasure(II)V
    ...
    invoke-super {p0, v0, p2}, Lamq;->onMeasure(II)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1317
    invoke-super {p0, p1}, Lamq;->onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 1321
    invoke-virtual {p1}, Lapw;->getSuperState()Landroid/os/Parcelable;

    move-result-object v0

    invoke-super {p0, v0}, Lamq;->onRestoreInstanceState(Landroid/os/Parcelable;)V

    .line 1322
    iget-boolean v0, p1, Lapw;->a:Z
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    .prologue
    .line 1308
    invoke-super {p0}, Lamq;->onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v1, v0}, Lapw;-><init>(Landroid/os/Parcelable;)V
...
.method public onWindowFocusChanged(Z)V
    ...
    .prologue
    .line 1238
    invoke-super {p0, p1}, Lamq;->onWindowFocusChanged(Z)V
...
.method public requestFocus(ILandroid/graphics/Rect;)Z
    ...
    .line 504
    :cond_3
    invoke-super {p0, p1, p2}, Lamq;->requestFocus(ILandroid/graphics/Rect;)Z
...
.method public setOnCloseListener(Lapt;)V
    .locals 0

    .prologue
    .line 534
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnCloseListener:Lapt;
...
.method public setOnQueryTextListener(Lapu;)V
    .locals 0

    .prologue
    .line 525
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnQueryChangeListener:Lapu;
...
.method public setOnSuggestionListener(Lapv;)V
    .locals 0

    .prologue
    .line 552
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mOnSuggestionListener:Lapv;
...
.method public setSuggestionsAdapter(Lwo;)V
    .locals 2

    .prologue
    .line 750
    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->mSuggestionsAdapter:Lwo;
