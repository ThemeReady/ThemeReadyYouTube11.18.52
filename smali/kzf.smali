...
# direct methods
.method public constructor <init>(Llab;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Lkyy;-><init>(Llab;)V

    iput-object v0, p0, Lkzf;->a:Lkyy;
    ...
    iput-object v0, p0, Lkzf;->b:Landroid/net/Uri;
    ...
    .line 48
    iput-object p4, p0, Lkzf;->d:Ljava/lang/String;

    .line 49
    return-void
.end method

.method private static a(Lorg/apache/http/HttpResponse;)Lvtv;
    .locals 3
...
.method private static b(Lorg/apache/http/HttpResponse;)Lvtu;
    .locals 3
...
# virtual methods
.method public final a(Llit;)Landroid/net/Uri;
    .locals 8
    ...
    .line 1135
    iget-object v1, p0, Lkzf;->b:Landroid/net/Uri;
    ...
    invoke-virtual {v2, v1}, Llal;->a(Landroid/net/Uri;)Lorg/apache/http/client/methods/HttpUriRequest;
    ...
    invoke-static {v2, v1}, Lkzf;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/lang/String;)V

    .line 61
    :goto_0
    invoke-virtual {p1}, Llit;->b()J
    ...
    .line 63
    :try_start_0
    iget-object v1, p0, Lkzf;->a:Lkyy;

    invoke-virtual {v1, v2}, Lkyy;->a(Lorg/apache/http/client/methods/HttpUriRequest;)Lorg/apache/http/HttpResponse;

    move-result-object v1

    .line 64
    invoke-static {v1}, Lkzf;->a(Lorg/apache/http/HttpResponse;)Lvtv;
    ...
    .line 2078
    :cond_1
    iget-object v1, p1, Llit;->a:Lliv;

    .line 2135
    iget-wide v2, v1, Lliv;->c:J
...
.method public final a(Lkyz;Llit;)Lkzl;
    .locals 8
    ...
    .line 2147
    iget-object v0, p0, Lkzf;->b:Landroid/net/Uri;
    ...
    invoke-virtual {v2, v0}, Llal;->a(Landroid/net/Uri;)Lorg/apache/http/client/methods/HttpUriRequest;
    ...
    invoke-static {v2, v0}, Lkzf;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/lang/String;)V

    .line 106
    :goto_1
    invoke-virtual {p2}, Llit;->b()J
    ...
    .line 108
    :try_start_0
    iget-object v0, p0, Lkzf;->a:Lkyy;

    invoke-virtual {v0, v2}, Lkyy;->a(Lorg/apache/http/client/methods/HttpUriRequest;)Lorg/apache/http/HttpResponse;
    :try_end_0
    .catch Lorg/apache/http/client/HttpResponseException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 129
    :cond_4
    invoke-static {v0}, Lkzf;->b(Lorg/apache/http/HttpResponse;)Lvtu;
    ...
    iget-object v2, v1, Lvtu;->a:[Lvts;

    iget-wide v4, v1, Lvtu;->b:J

    invoke-direct {v0, p1, v2, v4, v5}, Lkzl;-><init>(Lkyz;[Lvts;J)V
