...
# direct methods
.method constructor <init>(Lgqn;Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;)V
    .locals 0

    iput-object p2, p0, Lhks;->a:Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;

    invoke-direct {p0, p1}, Liht;-><init>(Lgqn;)V
...
.method protected final synthetic a(Lcom/google/android/gms/common/api/Status;)Lgqx;
    ...
    invoke-direct {v1, p1, v0}, Liia;-><init>(Lcom/google/android/gms/common/api/Status;Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenResponse;)V
...
.method protected final synthetic a(Lgql;)V
    ...
    .line 1000
    iget-object v1, p0, Lhks;->a:Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;

    .line 2000
    new-instance v2, Lhkq;

    invoke-direct {v2, p0}, Lhkq;-><init>(Lgre;)V

    .line 3000
    iget v0, p1, Lhko;->b:I

    iget-object v3, p1, Lhko;->a:Landroid/content/Context;

    invoke-virtual {v3}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v3

    iget-object v4, p1, Lhko;->c:Ljava/lang/String;
    ...
    .line 2000
    :try_start_0
    invoke-virtual {p1}, Lhko;->m()Landroid/os/IInterface;

    move-result-object v0

    check-cast v0, Lhke;

    invoke-interface {v0, v1, v6, v2}, Lhke;->a(Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenRequest;Landroid/os/Bundle;Lhkk;)V
    :try_end_0
    ...
    invoke-virtual {v2, v1, v0, v3}, Lhkq;->a(Lcom/google/android/gms/common/api/Status;Lcom/google/android/gms/wallet/firstparty/GetBuyFlowInitializationTokenResponse;Landroid/os/Bundle;)V
